...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (!empty($_POST['action']) && $utility->inputDecode($_POST['action']) == 'FORM_submit_application') {
        try {
            $applicant_id = $_SESSION['applicant_id'] ?? null;
            if (!$applicant_id) throw new Exception("User not logged in.");
            ...
            $utility->setFlash("success", "✅ Application submitted successfully!");
            header("Location: ../../applicant/previewform.php");
            exit;
        } catch (Exception $e) {
