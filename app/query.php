...
if (
    ...
    if ($applicantId) {
        ...
        $prog_data = $model->getRows("programme_details", [
            "where" => ["prog_applicant_id" => intval($applicantId)],
            'left_join' => [
                'courses' => ' on programme_details.prog_course_id = courses.course_id',
                'study_centre' => ' on programme_details.prog_centre_id = study_centre.centre_id'
            ],
            "return_type" => "single"
        ]);
