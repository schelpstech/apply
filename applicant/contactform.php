                    ...
                    <div class="row">
                        <div class="col-sm-10 col-xl-8 m-auto">
                            ...
                            <form id="contactForm" action="../app/applicant/formhandler.php" method="POST" novalidate autocomplete="off">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control border-0 bg-light rounded ps-3" id="state_residence" name="state_residence" required>
                                            ...
                                            foreach ($states as $state) {
                                                $selected = ($applicant_contact_data['state'] ?? '') === $state ? 'selected' : '';
                                ...
                                <input type="hidden" name="action" value="<?= $utility->inputEncode('FORM_submit_contact') ?>">

                                <hr class="my-4">

                                <div class="d-grid">
                                    <button type="submit" class="btn btn-warning btn-lg rounded-pill">Save Contact Info</button>
                                </div>
                            </form>
